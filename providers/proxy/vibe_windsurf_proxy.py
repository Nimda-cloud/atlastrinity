...
Usage:
    python scripts/vibe_windsurf_proxy.py                    # Default port 8085
    python scripts/vibe_windsurf_proxy.py --port 8086       # Custom port
...
try:
    ...
    print("Please ensure providers.windsurf is available")
    sys.exit(1)
