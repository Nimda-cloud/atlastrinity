...
class ModernCalculator:
    def __init__(self, root):
        ...
        # Large display
        input_field = tk.Label(display_frame, textvariable=self.input_text, font=('Helvetica', 48), 
                               fg="#ffffff", bg="#1e1e1e", anchor="e", padx=20, pady=20)
        ...
        for btn_info in buttons:
            ...
            btn = tk.Button(btns_frame, text=text, font=('Helvetica', 20, 'bold'), 
                            fg=fg_color, bg=bg_color, activebackground=active_bg,
                            activeforeground=fg_color, bd=0, highlightthickness=0,
