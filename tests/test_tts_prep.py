...
async def test_prepare_speech_text(mock_config):
    ...
    mock_config.get.side_effect = lambda key, default=None: True if key == "voice.tts.force_ukrainian" else default
...
async def test_prepare_speech_text_no_translation(mock_config):
    ...
    mock_config.get.side_effect = lambda key, default=None: False if key == "voice.tts.force_ukrainian" else default
