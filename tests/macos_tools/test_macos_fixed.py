...
FIXED_TOOLS_SCENARIOS = [
    ...
    (
        ...
        {"body": "Test note content", "folder": "Notes"},
        "Create note",
    ),
    # Calendar (2)
    (
    ...
    (
        ...
        {"title": "MCP Test Event", "date": "2026-02-10T12:00:00Z"},
        "Create event",
    ),
    # Reminders (2)
    ...
    (
        "macos-use_mail_send",
        {"to": "test@example.com", "subject": "Fixed MCP Test", "body": "Fixed test email"},
        "Send test email",
    ),
    # AppleScript (1)
    (
        "macos-use_run_applescript",
        {"script": 'return "Fixed AppleScript test successful"'},
        "Run AppleScript",
    ),
    # System Control (1)
    (
        "macos-use_send_notification",
        {"title": "Fixed MCP Test", "message": "Testing all 42 tools with correct params"},
        "Show notification",
    ),
...
async def main():
    ...
    results = {"success": 0, "error": 0, "timeout": 0, "total": len(FIXED_TOOLS_SCENARIOS)}
