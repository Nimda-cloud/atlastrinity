...
REAL_TOOLS_SCENARIOS = [
    ...
    # Screenshots & OCR (4)
    ("macos-use_take_screenshot", {"path": str(TEST_DIR / "final_screenshot.png")}, "Take screenshot"),
    ...
    ("macos-use_notes_create_note", {"folder": "Notes", "title": "MCP Test", "content": "Test note"}, "Create note"),
    ("macos-use_reminders", {}, "Get reminders"),
    ("macos-use_create_reminder", {"list": "Reminders", "title": "MCP Test Reminder"}, "Create reminder"),
    ...
    ("macos-use_mail_send", {"to": "test@example.com", "subject": "Final MCP Test", "body": "Final test email"}, "Send test email"),
    
    # AppleScript (1)
    ("macos-use_run_applescript", {"script": 'return "Final AppleScript test successful"'}, "Run AppleScript"),
    
    # System Control (3)
    ("macos-use_send_notification", {"title": "Final MCP Test", "message": "Testing all 42 tools"}, "Show notification"),
...
async def main():
    ...
    results = {
        ...
        "error": 0, 
        "timeout": 0,
        "total": len(REAL_TOOLS_SCENARIOS)
    }
