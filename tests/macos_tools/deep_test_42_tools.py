...
DEEP_TEST_SCENARIOS = [
    ...
    ("macos-use_open_application_and_traverse", {"identifier": "com.apple.TextEdit"}, "Open TextEdit with traversal"),
    ("macos-use_open_application_and_traverse", {"identifier": "com.apple.calculator"}, "Open Calculator with traversal"),
    ...
    ("macos-use_drag_and_drop_and_traverse", {"startX": 100, "startY": 100, "endX": 200, "endY": 200}, "Drag and drop"),
    ...
    ("macos-use_run_applescript", {"script": 'return "Deep AppleScript test successful"'}, "Simple AppleScript"),
    ("macos-use_run_applescript", {"script": 'tell application "Finder" to get name of front window'}, "Get Finder window"),
    
    # 10. Calendar
    ("macos-use_calendar_events", {"start": "2026-02-09T00:00:00Z", "end": "2026-02-10T00:00:00Z"}, "Get calendar events"),
    ("macos-use_create_event", {"title": "Deep Test Event", "date": "2026-02-10T15:00:00Z"}, "Create event"),
    ("macos-use_create_event", {"title": "Another Test Event", "date": "2026-02-11T10:00:00Z"}, "Create second event"),
    ...
    # 13. Notifications
    ("macos-use_send_notification", {"title": "Deep Test", "message": "Testing all tools"}, "Send notification"),
    ...
    ("macos-use_notes_create_note", {"body": "Deep test note content\nSecond line", "folder": "Notes"}, "Create note"),
    ...
    ("macos-use_mail_send", {"to": "test@example.com", "subject": "Deep Test", "body": "Testing mail functionality"}, "Send test email"),
    ...
    for i, (tool_name, args, description) in enumerate(DEEP_TEST_SCENARIOS, 1):
        ...
        try:
            result = await asyncio.wait_for(
                manager.call_tool('macos-use', tool_name, args), 
                timeout=30.0
            )
