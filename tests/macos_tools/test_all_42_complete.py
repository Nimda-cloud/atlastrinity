...
ALL_42_TOOLS = [
    ...
    # Screenshots & OCR (5)
    ("macos-use_take_screenshot", {"path": "/tmp/complete_test_screenshot.png"}, "Take screenshot to file"),
    ...
    ("macos-use_notes_create_note", {"body": "Complete test note content", "folder": "Notes"}, "Create note"),
    
    # Calendar (2)
    ("macos-use_calendar_events", {"start": "2026-02-09T00:00:00Z", "end": "2026-02-10T00:00:00Z"}, "Get calendar events"),
    ("macos-use_create_event", {"title": "Complete Test Event", "date": "2026-02-10T12:00:00Z"}, "Create event"),
    ...
    ("macos-use_mail_send", {"to": "test@example.com", "subject": "Complete Test", "body": "Complete test email"}, "Send test email"),
    
    # AppleScript (1)
    ("macos-use_run_applescript", {"script": 'return "Complete test successful"'}, "Run AppleScript"),
    ...
    # Notifications (1)
    ("macos-use_send_notification", {"title": "Complete Test", "message": "Testing all 42 tools"}, "Send notification"),
