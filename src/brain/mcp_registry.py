...
SERVER_CATALOG: Dict[str, Dict[str, Any]] = {
    ...
    "vibe": {
        ...
        "tier": 2,
        "category": "ai",
        "description": "AI-powered debugging and self-healing (Mistral CLI)",
        "capabilities": [
            "Deep error analysis with auto-fix",
            "Code review",
            "Smart planning for complex objectives",
            "Read-only Q&A",
            "Session management",
        ],
        "key_tools": [
        ...
        "when_to_use": "Complex debugging, code analysis, self-healing, AI-assisted coding",
    },
    "git": {
        "name": "git",
        "tier": 2,
