...
class SemanticLinker:
    ...
    KEY_HINTS = [
        "id", "uid", "uuid", "guid", "email", "phone", "serial", 
        "code", "sku", "isbn", "vin", "passport", "tax_id", 
        "account", "product", "user", "client", "customer"
    ]

    async def discover_links(self, new_df: pd.DataFrame, new_node_id: str, namespace: str = "global") -> List[Dict[str, Any]]:
        """
        ...
        dataset_nodes = [n for n in existing_graph["nodes"] if n["type"] == "DATASET" and n["id"] != new_node_id]
