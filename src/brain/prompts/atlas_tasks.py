...
714. **META-PLANNING & UNSTOPPABLE GOAL ACHIEVEMENT**:
...
8. **DYNAMIC VECTOR (DEVIATION)**:
    - The plan is a "behavior vector", not a strict chain.
    - If execution reveals a shortcut or a blocker, you MUST deviate.
    - Do not stick to a failing plan. Persist in the GOAL, not the METHOD.
"""
