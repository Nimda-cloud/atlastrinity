...
BINARY_PATH = os.path.join(
    os.getcwd(), "vendor/mcp-server-macos-use/.build/release/mcp-server-macos-use"
)
...
def main():
    ...
    tools_to_test = [
        ...
        (
            ...
            {"startX": 10, "startY": 10, "endX": 100, "endY": 100},
        ),
        ...
        (
            ...
            {"seconds": 2, "message": "Quick Test", "notification": True},
        ),
        ...
        (
            ...
            {
                "title": "System Alert",
                "message": "Native Verification Phase Complete",
                "sound": True,
            },
        ),
        ...
        (
            ...
            {"path": os.path.expanduser("~/Documents"), "limit": 10, "metadata": True},
        ),
        ...
        (
            ...
            {"action": "encrypt", "path": "/tmp/test.txt", "password": "secure_pass"},
        ),
        # --- Expansion Tools (60+) ---
