...
class ComprehensiveTester:
    ...
    async def run_test(self, tool_name, params, test_type="basic"):
        ...
        try:
            ...
            try:
                ...
                is_success = process.returncode == 0 and not response.get("result", {}).get(
                    "isError", True
                )
    ...
    async def run_comprehensive_tests(self):
        ...
        test_cases = [
            ...
            (
                ...
                {"create": True, "name": "test", "script": 'tell application "Finder" to beep'},
                "create",
            ),
            # Calendar Tests
            (
            ...
            (
                ...
                {"title": "Test Event", "date": "2026-02-10T15:00:00Z"},
                "basic",
            ),
            # Reminders Tests
            ...
            (
                ...
                {"folder": "Test", "title": "Test Note", "content": "Test content"},
                "basic",
            ),
            ...
            (
                ...
                {"text": "Test clipboard content", "addToHistory": True},
                "basic",
            ),
            ...
            (
                ...
                {"path": "/tmp/test_screenshot.png", "format": "png"},
                "basic",
            ),
            (
                "macos-use_take_screenshot",
                {"path": "/tmp/test_screenshot.jpg", "format": "jpg"},
                "format",
            ),
            ...
            (
                "macos-use_voice_control",
                {"command": "take screenshot", "language": "en-US"},
                "voice",
            ),
            ...
            (
                ...
                {"action": "priority", "pid": 1, "priority": "high"},
                "priority",
            ),
            (
            ...
            (
                "macos-use_file_encryption",
                {"action": "decrypt", "path": "/tmp/test.txt.encrypted", "password": "test123"},
                "decrypt",
            ),
            ...
            (
                ...
                {"metric": "cpu", "duration": 5, "alert": True, "threshold": 50.0},
                "alert",
            ),
            ...
            (
                "macos-use_execute_command",
                {"command": "echo 'Hello from shell'", "timeout": 5},
                "basic",
            ),
            ("macos-use_execute_command", {"command": "ls -la /tmp", "timeout": 5}, "listing"),
            (
                "macos-use_open_terminal",
                {"command": "echo 'Terminal test'", "execute": False},
                "basic",
            ),
            (
                "macos-use_open_terminal",
                {"command": "echo 'Auto execute'", "execute": True},
                "execute",
            ),
            # Spotlight Tests
    ...
    def generate_report(self):
        ...
        for result in self.results:
            ...
            if any(
                keyword in tool_name for keyword in ["click", "type", "press", "scroll", "drag"]
            ):
                categories["automation"].append(result)
            elif any(
                keyword in tool_name for keyword in ["system_control", "get_time", "countdown"]
            ):
                ...
                for keyword in ["calendar", "reminders", "notes", "mail", "notification"]
            ):
                categories["productivity"].append(result)
            elif any(
                keyword in tool_name for keyword in ["finder", "spotlight", "execute_command"]
            ):
    ...
    def print_summary(self, report):
        ...
        for cat_name, cat_stats in report["categories"].items():
            print(
                f"   {cat_name.title()}: {cat_stats['successful']}/{cat_stats['total']} ({cat_stats['success_rate']:.1f}%)"
            )
        print()
