...
def create_project():
    ...
    print_warning(
        "IMPORTANT: You must enable Billing for this project in the Google Cloud Console."
    )
    print_warning(
        "Without billing, maps will show 'for development purposes only' watermark and be darkened."
    )
...
def get_or_create_api_key(project_id):
    ...
    try:
        ...
        print_info(
            "Please create an API key manually at: https://console.cloud.google.com/google/maps-apis/credentials"
        )
