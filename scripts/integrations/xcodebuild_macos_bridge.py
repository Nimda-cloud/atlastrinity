...
class MacOSToolsBridge:
    ...
    async def call_enhanced_tool(self, tool_name: str, params: dict[str, Any]) -> dict[str, Any]:
        ...
        # Call macOS tool
        result = await self.call_macos_tool_direct(
            enhanced_config["macos_tool"], 
            converted_params
        )
    ...
    async def call_macos_tool_direct(self, tool_name: str, params: dict[str, Any]) -> dict[str, Any]:
