...
for m in reasoning_models:
    ...
    print(
        f"{emoji} {m['id']:30} | {m['name']:25} | Max: {m['max_tokens']!s:6} | Tools: {m['tool_calls']}"
    )

print("\n" + "=" * 80)
print(f"Total reasoning models found: {len(reasoning_models)}")
print("\n✅ = Available in VS Code model picker")
