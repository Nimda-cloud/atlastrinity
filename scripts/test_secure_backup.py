...
def create_test_database_with_secrets():
    ...
    test_data = [
        (1, 'Google Maps integration', 'AIzaSyDemoApiKeyPlaceholderForTesting', 'ghp_demo_token_placeholder'),
        (2, 'Mistral API connection', 'demo_mistral_key_placeholder', 'Bearer demo_token_placeholder'),
...
def test_secure_backup():
    ...
    try:
        ...
        # Cleanup test files
        cleanup_files = [
            test_db, filtered_db, encrypted_file, 
            decrypted_file
        ]
